...
<head>
  ...
  <title><?=cclang("LOGIN SYSTEM")?></title>
  <!-- plugins:css -->
        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <h4><?=cclang("LOGIN SYSTEM")?></h4>
              <h6 class="font-weight-light"><?=cclang("Please login to manage the system")?></h6>
              <form class="pt-3" action="<?=site_url(LOGIN_ROUTE."/action")?>" id="form">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail"><?=cclang("Email")?></label>
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" name="email" placeholder="<?=cclang("Email")?>">
                  </div>
                  <div id="email"></div>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword"><?=cclang("Password")?></label>
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                    ...
                    <input type="password" class="form-control form-control-lg border-left-0" name="password" placeholder="<?=cclang("Password")?>">
                  </div>
                  <div id="password"></div>
                </div>
                <div class="my-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" name="submit" id="submit"><?=cclang("LOGIN")?></button>
                </div>
              </form>
            </div>
          </div>
