...
public function __construct()
  ...
  private function _get_datatables_query()
    ...
    public function _get_join()
    {
      ...
      $this->db->select("auth_user.army_id");
      $this->db->join("auth_user","auth_user.army_id = army.a_armyid","left");
      // ตำแหน่ง
    ...
    public function get_detail($id)
    {
        ...
        $this->db->where("".$this->table.'.'.'a_armyid', profile('army_id'));
