    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-2">
                ...
                <a href="<?=url("army_rank/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i><?=cclang("Filter")?></a>
              </div>

        <form autocomplete="off" class="content-filter">
          <div class="row">
            <div class="form-group col-md-6">
              <input type="text" id="since" class="form-control form-control-sm" placeholder="ตั้งแต่" />
            </div>
            ...
            <div class="form-group col-md-6">
                        ...
                        --->
                <?=is_select_filter("rank","rank_id","r_id","r_fname","ยศ");?>
            </div>
            ...
            <div class="form-group col-md-6">
                        <!--
                          ...
                          is_select("table", "attribute`id & name`", "value", "label", "entry_value`optional`");
                        --->
                <?=is_select_filter("army","user_id","a_id","a_fname","กำลังพล");?>
            </div>

            <div class="form-group col-md-6">
              <input type="text" id="evidence" class="form-control form-control-sm" placeholder="หลักฐาน" />
            </div>

            <div class="form-group col-md-6">
              <input type="date" id="dated" class="form-control form-control-sm" placeholder="ลงวันที่" />
            </div>

            <div class="form-group col-md-6">
              <input type="datetime-local" id="created_at" class="form-control form-control-sm" placeholder="สร้างเมื่อ" />
            </div>
            ...
            <div class="form-group col-md-6">
                        <!--
                          ...
                          is_select("table", "attribute`id & name`", "value", "label", "entry_value`optional`");
                        --->
                <?=is_select_filter("auth_user","created_by","id_user","name","ผู้สร้าง");?>
            </div>
          ...
          <table class="table table-bordered table-striped" id="table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead>
              <tr class="text-center">
                                    <th><?=cclang("Id")?></th>
                                      <th><?=cclang("ตั้งแต่")?></th>
                                      <th><?=cclang("ยศ")?></th>
                                      <th><?=cclang("กำลังพล")?></th>
                                      <th><?=cclang("หลักฐาน")?></th>
                                      <th><?=cclang("ลงวันที่")?></th>
                                      <th><?=cclang("สร้างเมื่อ")?></th>
                                      <th><?=cclang("ผู้สร้าง")?></th>
